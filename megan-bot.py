...
async def setup_applications(interaction: discord.Interaction, channel: discord.TextChannel):
    ...
    # 🆕 V1.3: ضع الصورة في أعلى الـ embed (وليست رسالة منفصلة)
    # نستخدم embed منفصل للصورة فقط، يظهر فوق الـ embed الرئيسي
    # ثم embed ثاني بالنص — يعطي تأثير "الصورة في أعلى الـ embed"
    ...
    # 🆕 تم حذف set_thumbnail (شعار السيرفر محذوف)
    # 🆕 تم حذف set_image (الصورة الآن في embed منفصل بالأعلى)
